...
static LG_LEDs_t Linear_Guide_LEDs_init()
{
	LG_LEDs_t lg_leds = {
			...
			.trimmung = LED_init(LED_Kalibrieren_Speichern_GPIO_Port, LED_Kalibrieren_Speichern_Pin, LED_OFF),
			.center_pos_set = LED_init(LED_Trimmen_GPIO_Port, LED_Trimmen_Pin, LED_OFF)
	};
	return lg_leds;
}
