...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|}
			\hline
			\textbf{Name}      & \textbf{Funktion}                                                                                              \\ \hline
			\textbf{Analog In} & \begin{tabular}[c]{@{}l@{}}Analog 0-10V\\ Drehzahlsollwert 0-4092$\frac{U}{min}$\end{tabular} \\ \hline
			\textbf{Out 1}     & Pulsausgang 12$\frac{Impulse}{U}$                                                             \\ \hline
			\textbf{Out 2}     & Fehler: 1 = keine Störung; 0 = Störung                                                                         \\ \hline
			\textbf{Out 3}     & Drehrichtung: 1 = Linkslauf; 0 = Rechtslauf                                                                    \\ \hline
		\end{tabular}%
	}
